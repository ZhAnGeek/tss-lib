...
protob:
	...
	@for protocol in message signature ecdsa-keygen ecdsa-presigning ecdsa-signing ecdsa-resharing eddsa-keygen eddsa-signing eddsa-resharing schnorr-keygen schnorr-signing schnorr-zilsigning schnorr-minasigning schnorr-resharing; do \
