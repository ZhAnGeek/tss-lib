...
protob:
	...
	@for protocol in message derivekey signature ecdsa-keygen ecdsa-presigning ecdsa-signing ecdsa-resharing eddsa-keygen eddsa-signing eddsa-resharing schnorr-keygen schnorr-signing schnorr-resharing; do \
