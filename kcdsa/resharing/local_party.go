...
func NewLocalParty(
	...
	p.temp.dgRound2Message2s = make([]tss.ParsedMessage, params.NewPartyCount())        // from t+1 of Old Committee
...
func (p *LocalParty) ValidateMessage(msg tss.ParsedMessage) (bool, *tss.Error) {
	...
	case *DGRound4Message, *DGRound1MessageNewParty, *DGRound2Message2:
