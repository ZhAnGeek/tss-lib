...
func (m te2mt25519) Domain() C.EllCurve   { return m.E0 }
func (m te2mt25519) Codomain() C.EllCurve { return m.E1 }
func (m te2mt25519) Push(p C.Point) C.Point {
	if p.IsIdentity() {
...
func (m te2mt25519) Pull(p C.Point) C.Point {
	if p.IsIdentity() {
